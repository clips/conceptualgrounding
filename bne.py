...
class EncoderBNE(BaseLSTM):
    ...
    def train(self, include_validation=True, stopping_criterion=True, amount_negative_names=1, reinitialize=True,
              normalize=True, verbose=True, update_iteration=100, outfile=''):
            ...
            if stopping_criterion:
                ...
                try:
                    ...
                    if validation_mrr < previous_mrr:
                        self.best_checkpoint = epoch_ref - 1
